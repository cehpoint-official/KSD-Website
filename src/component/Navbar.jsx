...
const Navbar = () => {
    ...
    return (
        <>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='text-lg hidden lg:block space-x-4'>
                                    <button onClick={toggleDropdown}>
                                        <a className='hover:text-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-50 focus:ring-opacity-50 py-2 px-4 rounded-sm' href="#">Home</a>
                                    </button>
                                    <button onClick={toggleServicesPage}>
                                        <a className='hover:text-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-50 focus:ring-opacity-50 py-2 px-4 rounded-sm' href="#">Services</a>
                                    </button>
                                    <button onClick={toggleIndustriesPage}>
                                        <a className={`hover:text-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-50 focus:ring-opacity-50 py-2 px-4 rounded-sm ${isIndustriesOpen ? 'text-pink-500' : ''}`} href="#">Industries</a>
                                    </button>
                                    <button onClick={toggleCompanyPage}>
                                        <a className={`hover:text-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-50 focus:ring-opacity-50 py-2 px-4 rounded-sm ${isCompanyOpen ? 'text-pink-500' : ''}`} href="#">Company</a>
                                    </button>
            ...
            <div className={`z-10 ${isServices ? '' : 'hidden'}  shadow-lg absolute text-white w-full mt-5 text-center md:text-start `}>
            ...
            <div className={`z-10 ${isIndustriesOpen ? '' : 'hidden'} shadow-lg  absolute text-white lg:w-auto md:w-auto w-full mt-5 text-center md:text-start sm:right-0`}>
            ...
            <div className={`z-10 ${isCompanyOpen ? '' : 'hidden'} shadow-lg absolute text-white  mt-5 right-0`}>

                <div className='flex bg-gray-900 mx-10 gap-10 p-10  '>
                    <div className=''>
