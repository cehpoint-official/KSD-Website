...
import Img1 from "../../asset/industries-img/Transportation/img-1.png"
import Img2 from "../../asset/industries-img/Transportation/img-2.png"
import Img3 from "../../asset/industries-img/Transportation/img-3.png"
import Img4 from "../../asset/industries-img/Transportation/img-4.png"
import Img5 from "../../asset/industries-img/Transportation/img-5.png"
import Img6 from "../../asset/industries-img/Transportation/img-6.png"
import Img7 from "../../asset/industries-img/Transportation/img-7.png"
import Img8 from "../../asset/industries-img/Transportation/img-8.png"
        ...
        <div className='bg-black text-white p-10 pt-24  '>
            ...
            <div class="grid grid-cols-12 gap-6 mt-20">
                ...
                <div class="lg:col-span-4 md:col-span-6 col-span-12 bg-white ...">
                    ...
                    <div class='text-start '>
                        <div className=' bg-white  text-black p-5'>
                            <p className='font-semibold text-xl'>Railway Component
                                Manufacturing</p>
                            <p className='my-3'>
                ...
                <div class="lg:col-span-4 md:col-span-6 col-span-12 bg-white ...">
                    ...
                    <div class='text-start '>
                        <div className='border-slate-500 bg-white  text-black p-5'>
                            <p className='font-semibold text-xl'>Crash Analysis</p>
                            <p className='my-3'>
