...
import Img1 from "../../../asset/main-services-page/Manufacturing/industrial/img-1.png"
import Img2 from "../../../asset/main-services-page/Manufacturing/industrial/img-2.png"
import Img3 from "../../../asset/main-services-page/Manufacturing/industrial/img-3.png"
import Img4 from "../../../asset/main-services-page/Manufacturing/industrial/img-4.png"
import Img5 from "../../../asset/main-services-page/Manufacturing/industrial/img-5.png"
import Img6 from "../../../asset/main-services-page/Manufacturing/industrial/img-6.png"
import Img7 from "../../../asset/main-services-page/Manufacturing/industrial/img-7.png"
import Img8 from "../../../asset/main-services-page/Manufacturing/industrial/img-8.png"
    ...
    return <div>
        ...
        <div className=" grid grid-cols-12 bg-black  text-black">
            ...
            <div className="col-span-12 bg-white md:col-span-6 lg:col-span-6 p-10 ps-14">
                <div className="md:text-4xl text-3xl font-bold ">Our Industrial Fabrication Manufacturing</div>
                <div className='border-b-4 w-48 mt-3 border-pink-600 rounded-xl'></div>

                <div className=" pt-6">
                    <p>
                        We are Manufacturer of Industrial Fabrication Works. And also provide all types of Services like Industrial Sheet Metal Works etc. Fabrication works : Machine Base, Structural Angle works, Heavy Industrial fabrication. Assembly Manufacturing, Control Panels, Generators canopy drip - tray, fences & Critical assemblies. Industrial & factory Sheds Construction, Shearing & Bending job works.
                    </p>
                    <p className='mt-3'>
                ...
                <div class=" lg:col-span-4 md:col-span-6 col-span-12 ...">
                    ...
                    <div class='text-start '>
                        <div className=' bg-white  text-black p-5'>
                            <p className='font-semibold text-xl'>Steel</p>
                            <p className='my-3'>
        ...
        <div class="grid grid-cols-12 gap-6 mt-20 py-10 px-10 lg:px-12 ">
            ...
            <div class="lg:col-span-4 md:col-span-6 col-span-12 ...">
                ...
                <div class='text-start '>
                    <div className='border-slate-500 bg-white  text-black p-5'>
                        <p className='font-semibold text-xl'>Aluminium </p>
                        <p className='my-3'>
