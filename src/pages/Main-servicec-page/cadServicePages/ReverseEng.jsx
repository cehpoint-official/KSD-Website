...
import Img1 from "../../../asset/Website-Picture-gallery/4.jpg"
...
const ReverseEng = () => {
    ...
    return <div>
        ...
        <div className='  py-10 px-8 bg-black '>
            <div className="bg-black text-white grid grid-cols-12  gap-4 py-4">
                <div className=" col-span-12 md:col-span-6 lg:col-span-6  p-4">
                    <img src={Img1} alt="" className=" object-cover h-full " />
                </div>

                <div className="col-span-12 md:col-span-6 lg:col-span-6 p-4 lg:mt-8 space-y-5 ">
