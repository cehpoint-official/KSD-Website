...
import Img1 from "../../../asset/Website-Picture-gallery/9.webp"
    ...
    return <div>
        ...
        <div className='bg-black text-white py-10 px-10 '>
            <div className=" grid grid-cols-12  gap-4 pb-16">
                <div className=" col-span-12 md:col-span-6 lg:col-span-6  p-4">
                    <img src={Img1} alt="" className=" object-fill h-[25rem] w-full" />
                </div>

                <div className="col-span-12 md:col-span-6 lg:col-span-6 p-4 space-y-5 lg:mt-10">
                    <div className="text-4xl font-bold">VMC Machining</div>
        ...
        <div className=" grid grid-cols-12 bg-black  text-black">
            ...
            <div className="col-span-12 bg-white md:col-span-6 lg:col-span-6 p-10 ps-14">
                <div className="md:text-4xl text-3xl font-bold ">Difference between CNC and VMC?</div>
                ...
                <div class=" lg:col-span-4 md:col-span-6 col-span-12 ...">
                    ...
                    <div class='text-start '>
                        <div className='border-slate-500 bg-white  text-black p-5'>
                            ...
                            <p className='my-3'>
                                The accuracy needed to manufacture every component of an airplane is increased by CNC. This includes everything from the outer   parts. The highest  when manufacturing CNC-machined aerospace components since they are often mission-critical.
                            </p>
                ...
                <div class="lg:col-span-4 md:col-span-6 col-span-12 ...">
                    ...
                    <div class='text-start '>
                        <div className='border-slate-500 bg-white  text-black p-5'>
                            ...
                            <p className='my-3'>
                                To meet patient needs, the medical industry primarily  accurate and high-quality products produced by CNC machinery.accuracy  the COVID-19 pandemic, when the need for medical products such as masks and rose, this dependence on CNC machines increased.
                            </p>
